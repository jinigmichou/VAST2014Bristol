...
public class HomeView extends JPanel implements ActionListener{
	...
	public HomeView(MainView frame) {
		...
		JButton btnLogAndDependencies = new JButton("log and dependencies");
		btnLogAndDependencies.addActionListener(new ActionListener() {
		...
		btnLogAndDependencies.setBounds(50, 227, 117, 29);
		add(btnLogAndDependencies);
